...
# Рассчитываем МЖЗ и ГЗ
df_with_names['МЖЗ'] = 0.0
df_with_names['ГЗ'] = 0.0

df_with_names.loc[df_with_names['СИСТЕМА УПРАВЛЕНИЯ ЗАПАСАМИ'] == "Система с фиксированным интервалом времени между заказами", 'МЖЗ'] = ((df_with_names['Количество'] / 252) * (5 + 1)).astype('float64')
df_with_names.loc[df_with_names['СИСТЕМА УПРАВЛЕНИЯ ЗАПАСАМИ'] == "Система с фиксированным интервалом времени между заказами", 'ГЗ'] = ((df_with_names['Количество'] / 252) * 5).astype('float64')
